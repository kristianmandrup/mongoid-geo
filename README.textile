...
h2. IMPORTANT: THIS IS A PRE-BETA BRANCH WHICH IS ALMOST WORKING - PLEASE CHIP IN TO HELP GET US TO THE 1.0 RELEASE
...
In my environment (mongoid 2.1.0 (from github mongoid/master), MongoDB shell version: 1.8.2), for some reason, the above statement causes a recursive stack error:

<pre>
  1) Mongoid::Extensions::Symbol::Inflections#near_max adds the $near and $maxDistance modifiers to the selector
     Failure/Error: Unable to find matching line from backtrace
     SystemStackError:
       stack level too deep
     # /Users/kristianconsult/.rvm/gems/ruby-1.9.2-p136/bundler/gems/mongoid-a11e8890461c/lib/mongoid/named_scope.rb:88
</pre>

This happens even without using _mongoid_geo_ !!! Anyone? Hmm, could be an error in the Address model definition?

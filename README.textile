...
h2. Status Update (June 9, 2011) 

Major refactoring trying to structure the code even better. 
- Created Shape classes to encapsulate the shape/array logic for Outer- and TwinOperators (geo criterions)
...
TODO:
- add #to_point functionality using GeoPoint
- make sure GeoPoint supports modes :lng_lat and lat_lng
- debug/test to make sure all functionality still works
- consider using 'haversine' gem (or extract) for haversine calculation

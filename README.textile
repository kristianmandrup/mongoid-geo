...
<pre>a = Address.where(:city => 'Munich')</pre>

In my environment (mongoid 2.0.2, MongoDB shell version: 1.8.1), for some reason, the above statement causes a recursive stack error:
...
Otherwise, most of the specs now seem to finally pass :)
